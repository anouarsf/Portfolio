...
<div className="timeline-experience">
  <div className="timeline-experience-body">
    ...
    <p className="time-experience">{this.props.startMonth}/{this.props.startYear} - {this.props.endMonth}/{this.props.endYear}</p>
    ...
    <h4 className="namejob-experience"> {this.props.jobName} </h4>
        ...
        <p className="description-experience">{this.props.descriptionJob}</p>
      </div>
    </div>
  </div>
</div>
